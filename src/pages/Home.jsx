...
const Home = () => {
  ...
  const [trendingProduct,setTrendigProduct] = useState([]);
  const [bestSalesProduct,setBestSalesProduct] = useState([]);
  const [moblileProducts,setMobileProducts] = useState([]);
  ...
  useEffect(()=>{
    ...
    setWirelessProducts(filteredWirelessProduct);
     setTrendigProduct(filteredTrendingProducts);
  },[])
  return (
    <Helmet title = {'Home'}>
          ...
          <Row>
            <Col lg = '6' md = '6'>
              <div className="hero__content">
                <p className="hero__subtitle">Trending Prodcut in {year}</p>
                <h2>Make Your Interior More Minimalistic  & Modern </h2>
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nulla quasi necessitatibus commodi cumque magni, omnis aliquam ullam dolor amet aliquid?</p>
      ...
      <section className="new__arrivals">
        <Container>
          <Row>
            ...
            <ProductList  data= {moblileProducts} />
